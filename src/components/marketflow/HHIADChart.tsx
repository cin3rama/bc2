...
export interface HHIADChartProps {
    data: TimeSeriesPoint[];
}

export interface HHIADChartHandle {
    getChart: () => Highcharts.Chart | undefined;
}

const HHIADChart = forwardRef<HHIADChartHandle, HHIADChartProps>(
    ({ data }, ref) => {
...
HHIADChart.displayName = 'HHIADChart';

export default HHIADChart;
