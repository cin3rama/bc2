                            ...
                            {isCreateOpen ? (
                                <div className="rounded border border-gray-200 dark:border-gray-800 p-4">
                                    ...
                                    <form className="space-y-4" onSubmit={handleCreateSubmit}>
                                        ...
                                        {duplicateRecovery ? (
                                            <div className="rounded border border-yellow-300 bg-yellow-50 px-3 py-3 text-xs text-yellow-900 dark:border-yellow-900 dark:bg-yellow-950/40 dark:text-yellow-200">
                                ...
                                <table className="min-w-full text-xs md:text-sm">
                                    ...
                                    {!loading && visibleRows.length === 0 ? (
                                        <tr>
                                            ...
                                            >
                                                No active AOI actor policies returned.
                                            </td>
                                        </tr>
                                    ) : null}
                                    </tbody>
