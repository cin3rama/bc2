...
export default function Layout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        if (mounted) {
            // Toggle the "dark" class on the <html> element based on darkMode
    ...
    return (
        ...
        <header className="w-full flex items-center justify-between p-3 sm:p-5 bg-gold dark:bg-darkgold h-[8vh]">
            <div className="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <h2 className="text-xs font-regular text-primary-dark dark:text-primary-dark">
        ...
        {menuOpen && (
            <nav className="fixed inset-0 z-50 bg-gray-100 dark:bg-gray-800 text-black dark:text-white flex flex-col items-center justify-center w-full max-w-screen-sm mx-auto shadow-lg">
                <ul className="flex flex-col items-center space-y-4 py-6 w-full">
                    ...
                    <li>
                        <Link href="/sentiment" onClick={() => setMenuOpen(false)}>
                            Market Sentiment
                        </Link>
                    </li>
                    <li>
        ...
        {/* Footer */}
        <footer className="w-full h-[6vh] flex items-center justify-center bg-gold dark:bg-darkgold text-text dark:text-text-dark p-1">
