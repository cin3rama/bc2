// /opt/frontend/a3therflow/app/marketflow-analytics-charts/MarketflowAnalyticsChartsClient.tsx
"use client";
...
export default function MarketflowAnalyticsChartsClient() {
    ...
    useEffect(() => {
        ...
        const bind = (from: any, toList: any[]) => {
            const el: HTMLElement | null =
                (from as any).renderTo ?? ((from.container as HTMLElement | null) ?? null);
            if (!el) return () => {};
            ...
            <section className="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                <div>
                    ...
                    <p className="mt-1 text-sm opacity-80">
                        ...
                        (MM) and Accumulators/Distributors (AD), plus the spread between them.
                    </p>
                </div>
